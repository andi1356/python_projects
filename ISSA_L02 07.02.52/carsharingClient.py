...
auth_status = tk.Button(master=frame, text='NOT AUTH',fg='red')
auth_status.pack(side='right')
...
class Client:
    ...
    def handle_message(self, command):
        if command == 'authorized':
            ...
            auth_status.configure(text='AUTH', fg='green')

        if command == 'not authorized':
            auth_status.configure(text='NOT AUTH', fg='red')
